...
public class JButtonEx extends JFrame {
	...
	private Icon icon1 = new ImageIcon("image/소라1.png");
	private Icon icon2 = new ImageIcon("image/치아키1.png");
	private Icon icon3 = new ImageIcon("image/모모하루1.png");
	private Icon icon4 = new ImageIcon("image/모키치1.png");
